...
var Item = function (_a) {
  ...
  <img src={"https://naver.github.io/egjs-infinitegrid/assets/image/" + ((num % 33) + 1) + ".jpg"} alt="egjs" style={{
            width: "100%",
            height: "100%",
        }}/>
    </div>;
...
function App() {
    ...
    return <src_1.FrameInfiniteGrid className="container" gap={5} frame={[
            [1, 1, 2, 2, 3],
            [1, 1, 4, 5, 5],
        ]} onRequestAppend={function (e) {
