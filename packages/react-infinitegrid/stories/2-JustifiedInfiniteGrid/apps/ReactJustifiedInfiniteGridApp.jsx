...
var Item = function (_a) {
  ...
  <div className="thumbnail">
    <img src={"https://naver.github.io/egjs-infinitegrid/assets/image/" + ((num % 33) + 1) + ".jpg"} data-grid-maintained-target="true" alt="egjs"/>
  </div>
...
function App() {
    ...
    return <src_1.JustifiedInfiniteGrid className="container" gap={5} onRequestAppend={function (e) {
